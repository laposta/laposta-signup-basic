...
= 3.2.1 =
* Fixed: A bug caused the plugin to always use the legacy v1.6 Laposta API wrapper, even on PHP >= 8.0. This has been corrected to ensure proper detection and use of the v2 wrapper.
