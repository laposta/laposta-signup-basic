...
/** @internal */
class SegmentApi extends \LapostaApi230\Api\BaseApi
{
    /**
    ...
    {
        return $this->sendRequest('GET', [$segmentId], ['list_id' => $listId]);
    }
    /**
    ...
    {
        $data['list_id'] = $listId;
        return $this->sendRequest('POST', [$segmentId], body: $data);
    }
    /**
     * Delete a segment.
     *
    ...
    {
        return $this->sendRequest('DELETE', [$segmentId], ['list_id' => $listId]);
    }
    /**
