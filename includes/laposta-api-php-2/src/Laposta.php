...
class Laposta
{
     ...
     */
    public function __construct(string $apiKey, ?ClientInterface $httpClient = null, ?RequestFactoryInterface $requestFactory = null, ?ResponseFactoryInterface $responseFactory = null, ?StreamFactoryInterface $streamFactory = null, ?UriFactoryInterface $uriFactory = null, bool $reuseApiInstances = \true)
    {
        $this->apiKey = $apiKey;
        ...
        $this->httpClient = $httpClient ?? new Client(streamFactory: $this->streamFactory, responseFactory: $this->responseFactory);
    }
    /**
    ...
    {
        return $this->reuseApiInstances ? $this->apiInstances[$className] ??= new $className($this) : new $className($this);
    }
    /**
