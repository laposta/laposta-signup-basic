...
class Request extends \LapostaApi\Http\Message implements RequestInterface
{
     ...
     */
    public function __construct(protected string $method, protected UriInterface $uri, protected StreamInterface $body, array $headers = [], protected ?string $requestTarget = null)
    {
