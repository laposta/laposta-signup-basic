...
- Version-scoped release build that rewrites the public namespace to the release semver, for example `LapostaApi230`.
- Release smoke test and packaged archive for the version-scoped distribution.
